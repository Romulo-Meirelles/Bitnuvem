...
#Region "Tools"
        Public Function http_build_query(ByVal ParameterNames() As String, ByVal ParameterValues() As String) As String
            Dim sRet As String = ""
            ...
            For i As Integer = 0 To ParameterNames.Length - 1
                sRet = String.Concat(sRet, If(sRet = "", "", "&"), ParameterNames(i), "=", ParameterValues(i))
            Next
            Return sRet
        End Function
